...
function(chimera_add_binding_test_boost_python test_name)
  if(NOT CHIMERA_TEST_Boost_PYTHON_LIBRARIES)
    message(STATUS "Skipping '${test_name}' test because Boost.Python is not found")
  endif()
...
endfunction(chimera_add_binding_test)
...
function(chimera_add_binding_test_pybind11 test_name)
  if(NOT pybind11_FOUND)
    message(STATUS "Skipping '${test_name}' test because pybind11 is not found")
  endif()
